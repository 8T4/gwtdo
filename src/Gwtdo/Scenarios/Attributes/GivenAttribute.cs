...
/// </summary>
/// <remarks>
/// The <see cref="GivenAttribute"/> can be used in the context of a testing framework or specification
...
public class GivenAttribute: Attribute, IGwtCustomAttribute
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="GivenAttribute"/> class with the specified description
