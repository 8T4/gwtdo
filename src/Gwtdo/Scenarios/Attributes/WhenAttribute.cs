...
/// </summary>
/// <remarks>
/// The <see cref="WhenAttribute"/> can be used in the context of a testing framework or specification
...
public class WhenAttribute: Attribute, IGwtCustomAttribute
{
    ...
    /// <summary>
    /// Initializes a new instance of the <see cref="WhenAttribute"/> class with the specified description
