...
public abstract partial class Feature<TContext> where TContext : IFeatureContext
{
    ...
    public static Feature<TContext> operator |(Feature<TContext> feature, And other) => feature;
    public static Feature<TContext> operator |(Feature<TContext> feature, ScenarioVariables other) => feature;
    public static Feature<TContext> operator |(Feature<TContext> feature, Arrange<TContext> other) => GwtStatements(feature, GwtConstants.GIVEN);
    public static Feature<TContext> operator |(Feature<TContext> feature, Act<TContext> other) => GwtStatements(feature, GwtConstants.WHEN);
    public static Feature<TContext> operator |(Feature<TContext> feature, Assert<TContext> other) => GwtStatements(feature, GwtConstants.THEN);
